 ...
 *
 *
 * Changelog: Joao Leitao (May 2021): added a new constructor to carry the
 * Exception that explains what generated this error.
 */
...
public class IllegalParameterException extends RuntimeException {
    ...
    public IllegalParameterException(String name, String message, Exception explanation) {
    	super("Parameter \"" + name + "\": " + message, explanation);
    }
